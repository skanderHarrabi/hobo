    ...
    46: function(t, e, i) {
        (function(t) {
            ...
            if (
                ...
                (t.PLUGINS.imageTUI = function(t) {
                    var i = t.$;
                    function n(t) {
                        i("#tuieditor").remove(), (t.style.display = "none");
                    }
                    return {
                        _init: function() {
                            var e = t.o_doc.body,
                                i = t.o_doc.createElement("div");
                            i.setAttribute("id", "tuiContainer"),
                                (i.style.cssText =
                                    "position: fixed; top: 0;left: 0;margin: 0;padding: 0;width: 100%;height: 100%;background: rgba(0,0,0,.5);z-index: 9998;display:none"),
                                e.appendChild(i);
                        },
                        launch: function(o) {
                            if ("object" === e(t.opts.tui)) {
                                var a = t.o_doc.createElement("div");
                                a.setAttribute("id", "tuieditor");
                                var d = t.o_doc.getElementById("tuiContainer");
                                d.appendChild(a), (d.style.display = "block");
                                var s = o.image.get(),
                                    c = t.opts.imageTUIOptions;
                                c.includeUI.loadImage = {
                                    path: s[0].src,
                                    name: " "
                                };
                                var r = new t.opts.tui.ImageEditor(
                                        t.o_doc.querySelector("#tuieditor"),
                                        c
                                    ),
                                    u = t.o_doc.getElementById("tuieditor");
                                (u.style.minHeight = "590px"),
                                    (u.style.width = "94%"),
                                    (u.style.height = "94%"),
                                    (u.style.margin = "auto"),
                                    i(".tui-image-editor-header-buttons").html(
                                    ...
                                    )[0].addEventListener("click", function(t) {
                                        n(d);
                                    }),
                                    i(
                                        ".tui-editor-save-btn"
                ...
                throw new Error(
                    "TUI image editor plugin requires image plugin."
                );
